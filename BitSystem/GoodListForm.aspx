...
<div class="well well-small">
	<ul class="nav nav-list">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Sale_net_Jun10_2021ConnectionString2 %>" SelectCommand="SELECT * FROM [Action_product]"></asp:SqlDataSource>
    </form>
    <!--
Footer
-->
